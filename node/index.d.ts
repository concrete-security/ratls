...
/**
 * Low-level HTTP request (buffered response)
 */
 ...
 */
export function http_stream_request(
  targetHost: string,
  serverName: string,
  method: string,
  path: string,
...
/**
 * Read chunk from streaming response
 */
export function stream_read(streamId: number, maxBytes?: number): Promise<Buffer>

/**
 * Close streaming response
 */
export function stream_close(streamId: number): Promise<void>
